 ...
 * 11
 * 如何查看源码 (class) ctrl + 选中指定的结构或 ctrl + shift t
 * 12
 ...
 * 查看类的结构：似于 ctrl+o
 * 28
 * 重构 ：修改变量名 与方法alt+shift+r
 * 29
 * 大写 转小/小写 转大(toggle case)  ctrl+shift+y
 *
 ...
 * 35
 * 生成 try try-catch 等(surround with) alt+shift+z
 * 36
 * 局部变量 抽取为成员(introduce field) alt+shift+ f
 * 37
 * 查找 /替换 (当前 ) ctrl+f
 * 38
 * 查找 (全局 ) ctrl+h
 ...
 * 44
 * 打开最近 修改的文件 (Recently Files) ctrl+E
 * 45
 * 关闭当前打开的代码栏 (close) ctr + w
 * 46
